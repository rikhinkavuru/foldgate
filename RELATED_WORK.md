...
- **Kotte, arXiv:2606.29054** ("When Can Conformal Risk Control Certify LLM Outputs?", solo, June 2026) — a **concurrent, independent** reweighting-invariant selective-risk abstention floor of the same abstract character as our impossibility theorem, in the **LLM** domain. This is the largest theory-scoop exposure. Own it up front and frame our theorem as the co-folding specialization (per-novelty-stratum localization + matching in-stratum achievability bracket), not a priority claim. Verified first author = **V. Kotte** (the earlier bib "S. Gupta et al." was wrong). Cited in the paper as `crcgupta`.
